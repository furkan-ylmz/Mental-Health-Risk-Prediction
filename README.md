...
Three feature selection techniques are benchmarked to select the top $k=4$ features:
...
Four machine learning architectures are evaluated across all subsets (12 combinations):
...
Üç farklı yöntemle en etkili $k=4$ özellik seçilerek modeller optimize edilmiştir:
...
Dört farklı model mimarisi toplam 12 konfigürasyon üzerinde test edilmiştir:
